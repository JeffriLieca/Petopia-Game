...
//        self.petComponentSprite!.addChild(self.seekingParticle!)
    ...
    override func didEnter(from previousState: GKState?) {
        ...
        let wand = WandAgentNode (scene: game, position: CGPoint(x: game.frame.midX + 100, y: game.frame.minY+150), size: CGSize(width: 200,height: 200))
